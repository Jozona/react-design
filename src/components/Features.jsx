            ...
            <div className='container mx-auto px-3 md:px-10'>
                <div className='px-5 py-32'>
                    ...
                    <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>
                        There are a couple of things I am thinking about but I cannot help to try and and try yet hre I am.
                    </p>
                </div>
                ...
                <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]'>
                    <BentoCard
                        ...
                        title={<>radi<b>a</b>nt</>}
                        description="bla bla bla bla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla bla"
                        isComingSoon
                    />
                </BentoTilt>
                ...
                <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
                    <BentoTilt className='bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2'>
                        <BentoCard
                            ...
                            title={<>Zig<b>m</b>a</>}
                            description="An inhuman belief that was shaped by thousands of years"
                        />
                    </BentoTilt>
